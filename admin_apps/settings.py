...
REPOSITORY_ROOT = os.path.join(os.path.abspath(os.path.dirname(__file__)), '..')
...
# system time zone.
TIME_ZONE = 'UTC'#PR: Greenwich anstelle von 'America/Chicago'
...
SECRET_KEY = 'fzb2ujjz97!ko-^3-elt&zgj@dx4dc0e8*!tb&gkf2(xlj&o2@'
